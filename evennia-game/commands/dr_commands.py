...
from world.dr_progression import advance_circle, circle_status, guild_ability_summary, guild_path_summary, guild_title, guild_title_ladder, study_room, train_skill, unlocked_guild_perks, use_guild_boon, use_guild_capstone, use_guild_drill, use_guild_focus, use_guild_passive, use_guild_practice, use_guild_rite, use_guild_technique
...
CHARACTER_HELP_TEXT = "\n".join(
    [
        ...
        "Guilds/Circles: registrar, join guild, guild/perks, title, abilities, guild path, focus, technique, passive, drill, practice, rite, boon, capstone, study, train, circle, circle status.",
...
CHARACTER_HELP_TOPICS = {
    ...
    "progression": "\n".join(
        [
            ...
            "4. Train and circle: use guild path, title, train, study, passive, drill, practice, boon, capstone, skills, circle status, circle, abilities, focus, and technique at your own guild registrar through Circle 10.",
