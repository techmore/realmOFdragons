...
CHARACTER_HELP_TEXT = "\n".join(
    [
        ...
        "Guilds/Circles: guilds, registrar, join guild, guild/perks, guild history, title, experience, abilities, guild path, guild plan, mentor, lesson, perk, signature, milestone, focus, technique, passive, drill, practice, rite, boon, capstone, mastery, study, train, circle, circle status.",
...
CHARACTER_HELP_TOPICS = {
    ...
    "progression": "\n".join(
        [
            ...
            "4. Train and circle: use guild path, guild plan, title, experience, train, study, mentor, lesson, perk, signature, milestone, passive, drill, practice, boon, capstone, mastery, skills, circle status, circle, abilities, focus, and technique at your own guild registrar through Circle 10.",
