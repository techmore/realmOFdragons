...
from world.dr_combat import advance, aim, appraise_enemy, bash, block, combat_status, defend, dodge, feint, flee, health_text, hurl, jab, loot_corpse, maneuver_guide, parry, range_status, respawn_room_enemies, rest, retreat, revive, room_enemy_ids, scan_room, shoot, skin_corpse, stance, target_enemy, wait_recover
...
CHARACTER_HELP_TEXT = "\n".join(
    [
        ...
        "Combat: scan, target <enemy>, appraise target, maneuvers/combat tactics, range, advance, retreat, combat, stance, aim, shoot/fire, hurl/throw, feint, jab/attack, bash, defend, dodge, parry, block, flee, wait/recover, rest, skin corpse, loot corpse, revive/stand.",
...
CHARACTER_HELP_TOPICS = {
    ...
    "progression": "\n".join(
        [
            ...
            "4. Train and circle: use guild path, guild plan, title, experience, train, study, mentor, lesson, perk, signature, milestone, passive, drill, practice, boon, capstone, skills, circle status, circle, abilities, focus, and technique at your own guild registrar through Circle 10.",
