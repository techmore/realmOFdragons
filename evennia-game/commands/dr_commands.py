...
CHARACTER_HELP_TEXT = "\n".join(
    [
        ...
        "Guilds/Circles: guilds, registrar, join guild, guild/perks, guild history, title, experience, abilities, guild path, perk, milestone, focus, technique, passive, drill, practice, rite, boon, capstone, study, train, circle, circle status.",
...
CHARACTER_HELP_TOPICS = {
    ...
    "progression": "\n".join(
        [
            ...
            "4. Train and circle: use guild path, title, experience, train, study, perk, milestone, passive, drill, practice, boon, capstone, skills, circle status, circle, abilities, focus, and technique at your own guild registrar through Circle 10.",
