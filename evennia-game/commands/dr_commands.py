...
from world.dr_combat import advance, aim, appraise_enemy, bash, combat_status, defend, flee, health_text, hurl, jab, loot_corpse, range_status, respawn_room_enemies, rest, retreat, revive, room_enemy_ids, scan_room, skin_corpse, stance, target_enemy, wait_recover
...
CHARACTER_HELP_TEXT = "\n".join(
    [
        ...
        "Combat: scan, target <enemy>, appraise target, range, advance, retreat, combat, stance, aim, hurl/throw, jab/attack, bash, defend, flee, wait/recover, rest, skin corpse, loot corpse, revive/stand.",
