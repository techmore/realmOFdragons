...
for (const expected of [
  ...
  'east',
  'Test Gear Stand',
  'NPC: Test Gear Stand clerk',
  'Stock refresh: static catalog; refreshed whenever the world fixture is reloaded',
  'buy itm-test-blade',
  'shop talk',
  'shop stock',
  'Goal Verification',
  'Guild Circle 10 Verification',
  '11 canonical DragonRealms guilds tracked for in-world joining',
  ...
  'Controls',
  'Gameplay is text-first: type commands at the prompt. The panels below are reference only.',
  'Forage',
  'Difficulty 1',
  'field herb bundle',
  'New here?',
  ...
  'target forage wolf-cub',
  'advance forage wolf-cub',
  'attack forage wolf-cub',
  'Character',
  'UiScout | Human | Modern fixed racial stats',
  ...
  'Inventory',
  'Test Gear Stand stocks this item and can buy it for about 2 trias.',
  'Test Gear Stand does not stock this item.',
  'Test Gear Stand buys matching salvage for about 1 trias.',
  'Ammo',
  'practice arrow',
  'itm-sting-arrow x4',
  'bundle 5 | resale estimate 1 trias each',
  'Test Gear Stand buys practice arrow from your ammo pouch for about 1 trias each.',
  'sell one',
